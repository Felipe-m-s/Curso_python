...
#* 7. Crie uma tupla com números de 1 a 10, converta-a para lista, adicione o número 11, e  depois converta novamente para tupla. 
#* Exiba o resultado final. 
print("\n", "-" * 30, "Atvidade 7", "-" * 30)

#* 8. Crie uma lista de nomes com repetições e converta-a em um conjunto para eliminar  duplicatas. 
#* Exiba a lista original e o conjunto resultante. 
print("\n", "-" * 30, "Atvidade 8", "-" * 30)

#* 9. Crie um dicionário onde as chaves são os números de 1 a 5 e os valores são seus  quadrados. 
#* Exemplo: {1:1, 2:4, 3:9, ...} 
